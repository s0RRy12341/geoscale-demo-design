  ...
  return (
    <div className="screen-enter min-h-screen flex flex-col" dir="rtl">
      ...
      <header className="flex items-center justify-between px-8 py-5 border-b border-gray-100">
        ...
        <span className="text-sm cursor-pointer" style={{ color: BRAND.gray500 }}>
          → חזרה
        </span>
      </header>
...
const MOCK_PERSONAS = [
  ...
  },
  {
    ...
    desc: "מאיה, בת 38, גרה בירושלים, אם.",
    age: "35-44",
    location: "ירושלים",
    tags: ["#פרוטלגיות מתחלף", "#אמא"],
    match: 95,
    emoji: "👩",
  },
  {
    name: "דוד",
    title: "גבר בגיל העמידה עם אהבה לסוסים",
    desc: "דוד, בן 47, מנהל חברת הייטק.",
    age: "45-54",
    location: "רמת גן",
    tags: ["#שונה", "#רכיבה"],
    match: 88,
  ...
  {
    name: "אורי",
    title: "חובב סוסים צעיר",
    desc: "אורי, בן 23, סטודנט למדעות.",
    age: "20-24",
    location: "תל אביב",
    tags: ["#סטודנט", "#אקטיבי"],
    match: 88,
  ...
  {
    name: "רונית",
    title: "אישה עצמאית בשנות ה-50 לחייה",
    desc: "רונית, בת 52, מעצבירה בתעופן.",
    age: "50-59",
    location: "חיפה",
    tags: ["#בריאות", "#חופש"],
    match: 82,
      ...
      <div className="max-w-4xl mx-auto w-full px-4 mt-2">
        ...
        <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-100">
          ...
          <p className="text-xs" style={{ color: BRAND.gray500 }}>
            כל קהל יעד מחפש אחרת. הסריקה בודקת איך AI מגלצ על המותג שלכם בשביל אנשי מחפשים שונים. בחרו את הרלוונטיים לכם.
          </p>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: active ? color : BRAND.gray400 }}>
                {active ? "סורק..." : progress >= 100 ? "הושלם ✓" : "ממתין"}
              </p>
            </div>
          </div>
